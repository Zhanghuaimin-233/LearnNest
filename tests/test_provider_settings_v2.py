...
def test_provider_settings_projects_the_real_webui_catalog_and_editable_limits(
    ...
    assert payload["adapters"] == [
        ...
        _adapter("mimo-tts", "MiMo TTS", "语音服务", "tts", False, "openai_chat"),
        _adapter(
            "local-asr", "faster-whisper large-v3", "语音识别", "asr", True, "local"
        ),
        _adapter("local-ocr", "PaddleOCR", "画面文字识别", "ocr", True, "local"),
        _adapter("windows-tts", "Windows 系统语音", "语音服务", "tts", True, "local"),
    ]
...
def test_v1_settings_migrate_and_unsupported_products_are_rejected(
    ...
    for preset in ("coding-plan", "openai-compatible", "cc-switch", "siliconflow"):
